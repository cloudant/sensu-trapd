...
cloudantDbcoreDbName = MibScalar((1, 3, 6, 1, 4, 1, 40277, 3, 1, 1, 2), OctetString().subtype(subtypeSpec=ValueSizeConstraint(0, 1024))).setMaxAccess("notifyonly")
if mibBuilder.loadTexts: cloudantDbcoreDbName.setDescription("The name of a missing database")
...
cloudantDbcoreMissingDbEvent = NotificationType((1, 3, 6, 1, 4, 1, 40277, 3, 1, 2, 6)).setObjects(*(("CLOUDANT-PLATFORM-MIB", "cloudantTrapLevel"), ("CLOUDANT-DBCORE-MIB", "cloudantDbcoreDbName"), ) )
if mibBuilder.loadTexts: cloudantDbcoreMissingDbEvent.setDescription("This event is generated when the DB Core service detects\nthat a necessary cluster database is missing.")
cloudantDbcoreAllDbsAvailableEvent = NotificationType((1, 3, 6, 1, 4, 1, 40277, 3, 1, 2, 7)).setObjects(*(("CLOUDANT-PLATFORM-MIB", "cloudantTrapLevel"), ) )
if mibBuilder.loadTexts: cloudantDbcoreAllDbsAvailableEvent.setDescription("This event is generated when the DB Core service detects\nthat all necessary cluster databases are available.")
